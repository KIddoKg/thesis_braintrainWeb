...
class EmployerDisPage extends StatefulWidget {
  EmployerDisPage({Key? key}) : super(key: key);

  @override
  _EmployerDisPageState createState() => _EmployerDisPageState();
}
...
class _EmployerDisPageState extends State<EmployerDisPage>
