...
// import 'employer_all_page.dart';
//
// class EmployerDelePage extends StatefulWidget {
//   EmployerDelePage({Key? key}) : super(key: key);
//
//   @override
//   _EmployerDelePageState createState() => _EmployerDelePageState();
// }
//
...
// ];
//
// class _EmployerDelePageState extends State<EmployerDelePage>
...
//       case "Tất cả":
//         if (mounted)
//           res = await Services.instance
//               .setContext(context)
//               .getMonitorList(page: page, size: dropdownRow, );
//         break;
//       case "Mã tài khoản":
//         res = await Services.instance
//             .listUserID(dataInput);
//         break;
//     }
//     // if (res) {
//     //   if (mounted)
...
//       var res = await Services.instance.setUserBL(id,false);
//
//       if (res != null) {
//         continue;
//       } else {
//         showLoadingIndicator = false;
//         showAlert(context, 'Thông báo', 'Phát hiện lỗi bất thường mời thao tác lại');
//         break;
//       }
//     }
//     selectID.clear();
//     initData();
//     showAlert(context, 'Thông báo', 'Đã xoá tài khoản trong danh sách theo dõi');
//   }
//
...
//     }
//
//     List<Map<String, dynamic>> result = groupedDeals.values.where((service) => service != null).toList();
//
...
//     }
//
//     List<Map<String, dynamic>> result = groupedDeals.values.where((status) => status != null).toList();
//
//     // Print the grouped and summarized deals
//     return result;
//   }
...
//                   });
//                   var res =
//                   await Services.instance.listUserID(idDeal);
//                   await Future.delayed(Duration(seconds: 1));
//                   if (res != null) {
//                     var data = res;
//                     infoDeal = data;
